...
from huaytools.pytorch.utils import cosine_similarity_dense
...
def _test():
    ...
    def _test_SimCSE():  # noqa
        ...
        def encode_wrapper(encoder, _inputs):
            """"""
            cls, hidden_states, all_hidden_states = encoder(*_inputs)
