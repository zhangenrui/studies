...
def split(*arrays, split_size: Union[int, float] = 0.2, random_seed=1, shuffled=True):
    """@NLP Utils
    将数据按比例切分
...
def simple_split(*arrays, val_size=0.25, random_seed=1, is_shuffle=True):
    """
    将数据按比例切分
...
def _test():
    ...
    def _test_split():
        ...
        data_a, data_b = simple_split(*data, is_shuffle=False)
        print(data_a)
        print(data_b)
